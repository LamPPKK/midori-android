...
internal class XanhWebChromeClient(
    ...
    override fun onProgressChanged(view: WebView?, newProgress: Int) = activity.onProgress(tabId, newProgress)

    override fun onReceivedTitle(view: WebView?, title: String?) = activity.onPageChanged(tabId, view?.url, title)
